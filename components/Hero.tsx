        ...
        >
            ...
            >
                <div  className='firsth1 overflow-hidden'>
                    <h1 className='sm:inline-flex items-center'>
                        ...
                        <span 
                            ...
                            className='inline-block pl-1 sm:pl-2 cursor-pointer'>
                            <svg fill="none" viewBox="0 0 131 136" 
                                className="c-bttn__morph w-[10vw] h-[10vw] sm:w-[6.5vw] sm:h-[6.5vw] bg-green rounded-full">
                ...
                <div className='scndh1 overflow-hidden'>
                    <h2 ref={scndRef}>Design Agency </h2>
                </div>
            </div>
