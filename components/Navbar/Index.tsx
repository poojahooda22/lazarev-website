...
function Header() {
  ...
  return (
    ...
    >
        <div className='max-w-screen-xl mx-auto flex items-center justify-center gap-[6vw] '>
            {/* //logo */}
            <div className='w-[28vw] sm:w-[8vw]'>
                ...
                >            
                    <div 
                        className={`listNav ${style.listNav} hidden sm:flex items-start whitespace-nowrap
